...
class Generator(nn.Module):
    ...
    def __init__(self, image_size=64, z_dim=100, channel=3, conv_dim=64):
        ...
        if self.imsize == 96: #STL-10
            layer1.append(spectral_norm(nn.ConvTranspose2d(z_dim, conv_dim * mult, 6)))
        elif self.imsize == 28: #MNIST
            layer1.append(spectral_norm(nn.ConvTranspose2d(z_dim, conv_dim * mult, 7)))
        else: # CIFAR10
        ...
        if self.imsize >= 128:
            layer5 = []
            layer5.append(spectral_norm(nn.ConvTranspose2d(curr_dim, int(curr_dim / 2), 4, 2, 1)))
        ...
        if self.imsize >= 256:
            layer6 = []
            layer6.append(spectral_norm(nn.ConvTranspose2d(curr_dim, int(curr_dim / 2), 4, 2, 1)))
        ...
        if self.imsize >= 512:
            layer7 = []
            layer7.append(spectral_norm(nn.ConvTranspose2d(curr_dim, int(curr_dim / 2), 4, 2, 1)))
        ...
        last.append(spectral_norm(nn.ConvTranspose2d(curr_dim, channel, 4, 2, 1)))
        last.append(nn.Tanh())
...
class Discriminator(nn.Module):
    ...
    def __init__(self, image_size=64, channel=3, conv_dim=64):
        ...
        if self.imsize == 96: #STL-10
            layer1.append(spectral_norm(nn.Conv2d(channel, conv_dim, 3, 3, 0)))
        elif self.imsize == 28: #MNIST
            layer1.append(spectral_norm(nn.Conv2d(channel, conv_dim, 4, 4, 2)))
        else:
            layer1.append(spectral_norm(nn.Conv2d(channel, conv_dim, 4, 2, 1)))
        ...
        if self.imsize >= 256:
            layer6 = []
            layer6.append(spectral_norm(nn.Conv2d(curr_dim, curr_dim * 2, 4, 2, 1)))
        ...
        if self.imsize >= 512:
            layer7 = []
            layer7.append(spectral_norm(nn.Conv2d(curr_dim, curr_dim * 2, 4, 2, 1)))
